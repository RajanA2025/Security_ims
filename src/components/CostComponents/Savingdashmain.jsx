...
export const Savingdashmain = () => {
  ...
  // Compute all summary values consistently
  const { totalPotentialSavings, realizedAmount, totalOpportunities, unassignedCost } = useMemo(() => {
    if (!resourcesData) return { totalPotentialSavings: null, realizedAmount: null, totalOpportunities: null, unassignedCost: null };
    ...
    // Total potential savings (use cost_savings first, fallback to cost)
    ...
    <div style={{ padding: "16px 0px 16px" }}>
      <Row gutter={[16, 16]}>
        ...
        <Col xs={24} sm={12} md={5}>
          <Card bodyStyle={cardStyle("white")} style={{ borderTop: "4px solid #52c41a" }}>
            ...
            <div style={{ textAlign: "center", marginTop: 10 }}>
              <Title level={4} style={valueTitleStyle}>
                ...
                {totalPotentialSavings !== null ? `$${totalPotentialSavings.toLocaleString()}` : "Loading..."}
              </Title>
            </div>
            <div style={{ textAlign: "center", marginTop: 10 }}>
              <Title level={4} style={valueTitleStyle}>
                ...
                {totalOpportunities !== null ? totalOpportunities : "Loading..."}
              </Title>
            </div>
          </Card>
        </Col>
        ...
        {/* Realized Savings */}
        <Col xs={24} sm={12} md={5}>
          <Card bodyStyle={cardStyle("white")} style={{ borderTop: "4px solid #1890ff" }}>
            <div style={headerStyle}>
        ...
        <Col xs={24} sm={12} md={5}>
          <Card bodyStyle={cardStyle("white")} style={{ borderTop: "4px solid #fa8c16" }}>
